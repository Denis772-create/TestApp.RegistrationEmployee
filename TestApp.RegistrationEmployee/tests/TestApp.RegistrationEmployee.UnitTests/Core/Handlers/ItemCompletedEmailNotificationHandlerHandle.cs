...
using TestApp.RegistrationEmployee.Core.ProjectAggregate;
using TestApp.RegistrationEmployee.Core.ProjectAggregate.Events;
using TestApp.RegistrationEmployee.Core.ProjectAggregate.Handlers;
using Xunit;

namespace TestApp.RegistrationEmployee.UnitTests.Core.Handlers
{
